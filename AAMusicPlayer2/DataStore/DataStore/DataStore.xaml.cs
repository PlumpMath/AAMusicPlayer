...
namespace Expression.Blend.DataStore.DataStore
{
	...
	public class DataStoreGlobalStorage
	{
		...
		private string _muted = string.Empty;
	...
	public class DataStore : System.ComponentModel.INotifyPropertyChanged
	{
		...
		public DataStore()
		{
			try
			{
				System.Uri resourceUri = new System.Uri("/AAMusicPlayer2;component/DataStore/DataStore/DataStore.xaml", System.UriKind.Relative);
		...
		public string muted
		{
			get
			{
				return DataStoreGlobalStorage.Singleton.muted;
			}

			set
			{
				DataStoreGlobalStorage.Singleton.muted = value;
			}
		}
	}
}
